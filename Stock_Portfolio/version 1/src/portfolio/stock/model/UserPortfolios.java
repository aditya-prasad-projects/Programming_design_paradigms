...
public interface UserPortfolios {
   ...
   * @param date th date at which the stock was bought.
   * @param data the data object from which the stock data is to be got.
   */
  void buyStocks(String portfolioName, String ticker, double price, String date, StockData data);
   ...
   */
  String portfolioContents(String portfolioName);
}
