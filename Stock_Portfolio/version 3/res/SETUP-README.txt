...
4. Run the command "java -jar StockPortfolio.jar -view gui" to run the program with a GUI or with "java -jar StockPortfolio.jar -view console" to run the program with a console based UI.
5. The program runs.
...
The documentation of JFreeChart is provided in the res folder along with the jars that the project must import to Intellij in the jars folder present in res.