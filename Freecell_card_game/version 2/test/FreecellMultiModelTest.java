...
/**
 * Tests FreecellMultiMoveModel class.
 */
public class FreecellMultiModelTest {
  ...
  public void testMoveOpen() {
    ...
    try {
      ...
      assertEquals(e.getMessage(), "The numbers must be in decending order");
    }
    assertEquals("F1: A♦, 2♦\n" +
            "F2:\n" +
            "F3:\n" +
  ...
  public void testFullGame() {
    FreecellOperations gameObject = FreecellMultiMoveModel
            .getBuilder()
            .opens(5)
            .build();
