...
public class FreecellMultiModelTest2 {
  ...
  @Before
  public void setup() {
    testNotStarted = FreecellMultiMoveModel
            .getBuilder()
            .build();

    testShuffled = FreecellMultiMoveModel
            .getBuilder()
            .build();
    testShuffled.startGame(testShuffled.getDeck(), true);

    testOrdered = FreecellMultiMoveModel
            .getBuilder()
            .build();
  ...
  public void testCascadeCascade() {
    try {
      ...
      assertEquals("Can't be added to destination card!", e.getMessage());
    }
    try {
      testOrdered.move(PileType.CASCADE, 0, 5, PileType.CASCADE, 1);
      fail();
    } catch (IllegalArgumentException e) {
      assertEquals("The colours must be alternating!", e.getMessage());
    }
    assertEquals("F1:\n" +
            "F2:\n" +
            "F3:\n" +
  ...
  /**
   * Test multimove correct.
   */
  @Test
  public void testMultiMove() {
    testOrdered = FreecellMultiMoveModel.getBuilder().cascades(14).build();
    List deck = testOrdered.getDeck();
    Collections.reverse(deck);
    testOrdered.startGame(deck, false);
    assertEquals("F1:\n" +
            "F2:\n" +
            "F3:\n" +
            "F4:\n" +
            ...
            "C12: 2♦, A♣, K♠\n" +
            "C13: A♦, K♥, Q♠\n" +
            "C14: K♣, Q♥, J♠", testOrdered.getGameState());
    testOrdered.move(PileType.CASCADE, 4, 0, PileType.CASCADE, 0);
    assertEquals("F1:\n" +
            "F2:\n" +
            "F3:\n" +
            "F4:\n" +
            ...
            "C13: A♦, K♥, Q♠\n" +
            "C14: K♣, Q♥, J♠", testOrdered.getGameState());
    //Test invalid destination pile card
    try {
      testOrdered.move(PileType.CASCADE, 2, 0, PileType.CASCADE, 0);
      fail();
    } catch (IllegalArgumentException e) {
      assertEquals("Can't be added to destination card!", e.getMessage());
    }

    //Test invalid color of destination
    try {
      testOrdered.move(PileType.CASCADE, 9, 1, PileType.CASCADE, 6);
      fail();
    } catch (IllegalArgumentException e) {
      assertEquals("Can't be added to destination card!", e.getMessage());
    }
    //test moving 2 cards
    testOrdered.move(PileType.CASCADE, 7, 2, PileType.CASCADE, 5);
    assertEquals("F1:\n" +
            "F2:\n" +
            "F3:\n" +
            "F4:\n" +
    ...
    //move multi card to empty pile
    testOrdered.move(PileType.CASCADE, 8, 0, PileType.CASCADE, 4);
  ...
  /**
   * Test multimove invalid colors.
   */
  @Test
  public void testInvalidColorMultiMove() {
    testOrdered = FreecellMultiMoveModel.getBuilder().cascades(27).build();
    List deck = testOrdered.getDeck();
    Collections.reverse(deck);
    testOrdered.startGame(deck, false);
    assertEquals("F1:\n" +
            ...
            "C25: 2♣, A♠\n" +
            "C26: A♣\n" +
            "C27: K♥", testOrdered.getGameState());
    try {
      testOrdered.move(PileType.CASCADE, 2, 0, PileType.CASCADE, 0);
      fail();
    } catch (IllegalArgumentException e) {
  ...
  /**
   * Test multimove invalid order.
   */
  @Test
  public void testInvalidOrderMultiMove() {
    testOrdered = FreecellMultiMoveModel.getBuilder().build();
    List deck = testOrdered.getDeck();
    testOrdered.startGame(deck, false);
    assertEquals("F1:\n" +
            "F2:\n" +
            ...
            "C8: 8♠, 3♥, J♥, 6♣, A♦, 9♦", testOrdered.getGameState());
    try {
      testOrdered.move(PileType.CASCADE, 0, 4, PileType.CASCADE, 2);
      fail();
    } catch (IllegalArgumentException e) {
      assertEquals("The numbers must be in decending order", e.getMessage());
    }
  }

  /**
   * Test multimove invalid equation.
   */
  @Test
  public void testInvalidEquationMultiMove() {
    testOrdered = FreecellMultiMoveModel.getBuilder().cascades(14).opens(1).build();
    List deck = testOrdered.getDeck();
    Collections.reverse(deck);
    testOrdered.startGame(deck, false);
    assertEquals("F1:\n" +
    ...
    try {
      ...
      assertEquals("Not enough empty open and cascade piles!", e.getMessage());
    }
  }

  /**
   * Test multimove to open and foundation piles.
   */
  @Test
  public void testMultiMoveOpenFoundation() {
    testOrdered = FreecellMultiMoveModel.getBuilder().cascades(14).build();
    List deck = testOrdered.getDeck();
    Collections.reverse(deck);
    testOrdered.startGame(deck, false);
    ...
    try {
      testOrdered.move(PileType.CASCADE, 4, 0, PileType.OPEN, 0);
    } catch (IllegalArgumentException e) {
      assertEquals("Only last card can be moved", e.getMessage());
    }
    try {
      testOrdered.move(PileType.CASCADE, 4, 0, PileType.FOUNDATION, 0);
    } catch (IllegalArgumentException e) {
      assertEquals("Only last card can be moved", e.getMessage());
    }
  }
